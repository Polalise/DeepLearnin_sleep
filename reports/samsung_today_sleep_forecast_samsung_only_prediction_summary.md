...
```text
data\processed\samsung_health\pre_sleep_stage1\live_forecast\today_samsung_only_raw_stage1_features.csv
```

## Outputs

```text
data\processed\samsung_health\pre_sleep_stage1\live_forecast\today_samsung_only_prediction.csv
data\processed\samsung_health\pre_sleep_stage1\live_forecast\today_samsung_only_prediction_summary.csv
```
...
- Mean probability: `0.4134`
- Median probability: `0.4134`
- P10/P90 probability: `0.4134` / `0.4134`

## Highest Probability Episodes

- `2026-06-30 23:30:00` | pred=0 | probability=0.4134 | `today_forecast__20260630233000`
